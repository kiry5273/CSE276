...
def main(args=None):
    ...
    # for task 5 to display facial expressions on the robot
    disp = Display()
    ...
    # for task 4 and 5, if the sensor has value, the robot will move in the according direction and show the according facial expression
    while True:
        ...
        minimal_client.send_move_request(display_sting)
        print(display_sting)
        time.sleep(0.5)
